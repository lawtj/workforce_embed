...
left, right, rest, end = st.columns([.2,.2,.3,.3])
with left:
        papslot = st.empty()
...
if out['last_active_drawing'] is None:
    ...
    papslot.write('**Population:**' + '<br>' + '**Total PAPs:**' + '<br>' + '**Total PAP density:**' + '<br>' + '**PAP 2015:**' + '<br>' + '**PAP density (2015):**', unsafe_allow_html=True)
    npapslot.write('**Total NPAPs:**' + '<br>' + '**Total NPAP density:**' + '<br>' + '**NPAP 2015:**' + '<br>' + '**NPAP density (2015):**', unsafe_allow_html=True)
else:
